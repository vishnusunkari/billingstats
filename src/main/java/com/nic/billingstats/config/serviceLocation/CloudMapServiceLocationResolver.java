...
public class CloudMapServiceLocationResolver implements ServiceLocationResolver {
    ...
    @Value("${aws.cloudmap.service.membership}")
    private String cloudMapServiceMembership;
    ...
    public String resolve() {
        ...
        discoverInstancesRequest.setServiceName(cloudMapServiceMembership);
        ...
        log.info("Given {}, found {}", cloudMapServiceMembership + "." + cloudMapNamespace, serviceLocation);
